...
/**
 * Abstract superclass for our Booking hierarchy. A booking provides a name, a
 * date (the point in time for which the booking was made), and a number of
 * persons.
 *
 * @author Carsten Fuhs
 */
public abstract class Booking {
    ...
    /**
     * Returns the number of persons for whom the booking has been made. Concrete
     * subclasses will need to provide a suitable implementation.
     *
     * @return the number of persons for which the booking has been made, greater
