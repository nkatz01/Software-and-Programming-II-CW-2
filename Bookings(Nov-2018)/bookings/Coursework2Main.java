...
public class Coursework2Main {
    ...
    public static void main(String[] args) {
        ...
        // exercise classes
        Booking[] bookings = { mkRickshawBooking(), mkHotelBooking(), mkRestaurantBooking(),
        ...
        HasFixedPrice[] fixedPrices = { mkFixedPriceRestaurantBooking(), mkHotelBooking() };
    ...
    /*
     *** RickshawBooking *** Name: Eric Date: Tue Aug 04 16:00:00 BST 2020 Persons: 1
     * From: Piccadilly Circus To: Malet Street HotelBooking *** Name: Sarah Date:
     * Tue Aug 04 16:00:00 BST 2020 Persons: 8 Location: Birkbeck Hotel Price: GBP
     * 450.00 Single rooms: 2 Double rooms: 3 RestaurantBooking *** Name: Ana Date:
     * Tue Aug 04 16:00:00 BST 2020 Persons: 8 Location: Birkbeck Restaurant
     *** FixedPriceRestaurantBooking *** Name: Nikos Date: Tue Aug 04 16:00:00 BST
     * 2020 Persons: 12 Location: Malet Restaurant Price: GBP 360.00
     * java.lang.IllegalArgumentException: Expected at least 0 singleRooms, found:
     * -2 Fixed Prices *** Pence: 36000 Pence: 45000
     */
}
